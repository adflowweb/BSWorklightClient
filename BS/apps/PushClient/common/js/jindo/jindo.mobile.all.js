...
jindo.$Jindo.checkVarType._throwException = function(aArgs, oRules, sFuncName) {
	...
	if (/(\$\w+)#(\w+)?/.test(sFuncName)) {
        sURL = 'http://jindo.dev.naver.com/docs/jindo/archive/Jindo2-2.9.1/mobile/ko/classes/' + encodeURIComponent(RegExp.$1) + '.html' + "#method_"+RegExp.$2;
    }
    
//     
	// if (/(\$\w+)(#\w+)?/.test(sFuncName)) {
		// sURL = 'http://jindo.dev.naver.com/docs/jindo/archive/Jindo2-2.9.1/mobile/ko/classes/' + encodeURIComponent(RegExp.$1) + '.html' + RegExp.$2;
	// }
